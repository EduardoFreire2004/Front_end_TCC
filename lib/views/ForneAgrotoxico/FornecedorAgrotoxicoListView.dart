...
class FornecedorAgrotoxicoListView extends StatefulWidget {
  ...
  @override
  State<FornecedorAgrotoxicoListView> createState() =>
      _FornecedorAgrotoxicoListViewState();
}

class _FornecedorAgrotoxicoListViewState
    extends State<FornecedorAgrotoxicoListView> {
      ...
      body: RefreshIndicator(
        ...
        child: Column(
          children: [
            Expanded(
              child:
                  viewModel.isLoading && viewModel.forneAgrotoxico.isEmpty
                              ...
                              child: ListTile(
                                ...
                                onTap:
                                    () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder:
                                            (_) => FornecedorAgrotoxicoFormView(
                                              fornecedor: fornecedor,
                                            ),
                                      ),
                                    ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed:
            () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const FornecedorAgrotoxicoFormView(),
              ),
            ),
