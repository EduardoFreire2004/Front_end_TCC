...
class FornecedorAgrotoxicoFormView extends StatefulWidget {
  ...
  const FornecedorAgrotoxicoFormView({Key? key, this.fornecedor})
    : super(key: key);

  @override
  State<FornecedorAgrotoxicoFormView> createState() =>
      _FornecedorAgrotoxicoFormViewState();
}

class _FornecedorAgrotoxicoFormViewState
    extends State<FornecedorAgrotoxicoFormView> {
  ...
  void _save() {
    if (_formKey.currentState!.validate()) {
      final fornecedor = ForneAgrotoxicoModel(
      ...
      final viewModel = Provider.of<ForneAgrotoxicoViewModel>(
        context,
        listen: false,
      );
  ...
  bool _nomeJaExiste(String nome) {
    ...
    final lista = viewModel.forneAgrotoxico;
