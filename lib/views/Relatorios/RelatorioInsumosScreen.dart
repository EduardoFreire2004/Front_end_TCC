...
class RelatorioInsumosScreen extends StatefulWidget {
  const RelatorioInsumosScreen({Key? key}) : super(key: key);

  @override
  State<RelatorioInsumosScreen> createState() => _RelatorioInsumosScreenState();
}

class _RelatorioInsumosScreenState extends State<RelatorioInsumosScreen> {
  DateTime? _dataInicio;
  DateTime? _dataFim;
  bool _isGenerating = false;
  String? _errorMessage;
  RelatorioAplicacoesDto? _relatorio;
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      _relatorio = await _relatorioService.gerarRelatorioInsumosEstoque(
        usuarioId: usuarioId,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Relatório de Insumos gerado com sucesso!'),
  ...
  Future<void> _generatePDF() async {
    ...
    // TODO: Implementar PDF específico para insumos
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('PDF de Insumos será implementado em breve'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoCard(
                        'Total de Aplicações',
                        _relatorio!.estatisticas.totalAplicacoes.toString(),
                      ),
                      _buildInfoCard(
                        'Área Total Aplicada',
                        '${_relatorio!.estatisticas.areaTotalAplicada.toStringAsFixed(2)} ha',
                      ),
