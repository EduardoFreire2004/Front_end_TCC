...
class RelatorioEstoqueScreen extends StatefulWidget {
  const RelatorioEstoqueScreen({Key? key}) : super(key: key);
...
class _RelatorioEstoqueScreenState extends State<RelatorioEstoqueScreen> {
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      _relatorio = await _relatorioService.gerarRelatorioEstoque(
        usuarioId: usuarioId,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Relatório de Estoque gerado com sucesso!'),
  ...
  Future<void> _generatePDF() async {
    ...
    // TODO: Implementar PDF específico para estoque
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('PDF de Estoque será implementado em breve'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoCard(
                        ...
                        (_relatorio!.estatisticas.totalEntradas +
                                _relatorio!.estatisticas.totalSaidas)
                            .toString(),
                      ),
                      _buildInfoCard(
                        'Entradas',
                        _relatorio!.estatisticas.totalEntradas.toString(),
                      ),
                      _buildInfoCard(
                        'Saídas',
                        _relatorio!.estatisticas.totalSaidas.toString(),
                      ),
